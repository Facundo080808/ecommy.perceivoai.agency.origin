      ...
      <div className="container relative z-10">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">{t("AiDashboardContent.sectionTitle")}</h2>
          </div>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-4">{t("AiDashboardContent.sectionDescription")}</p>
          ...
          <div className="bg-gradient-to-r from-gray-900 to-gray-800 p-6 text-white">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold">{t("AiDashboardContent.dashboardTitle")}</h3>
                  <p className="text-gray-300 text-sm">{t("AiDashboardContent.dashboardSubtitle")}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
